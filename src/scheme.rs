...
//!
//! What's NOT modeled (yet, deliberately): pre/post actions, environment
//! variables, launch arguments, test plans, custom working directory,
//! debugger / launcher identifiers. Add these incrementally as concrete
//! callers need them — see CLAUDE.md "minimum abstraction."
...
pub fn from_element(root: &Element) -> Result<Scheme, Error> {
    ...
    Ok(Scheme {
        ...
        test_action,
        launch_configuration: action_configuration(root, "LaunchAction"),
